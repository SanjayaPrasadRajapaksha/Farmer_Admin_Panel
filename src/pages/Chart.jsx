    ...
    <div className="bg-white border border-gray-200 rounded-md p-3 shadow-sm text-sm">
      ...
      <div className="mt-2 space-y-1">
        ...
        <div className="flex items-center justify-between gap-4 pt-1 border-t border-gray-100">
          <span className="text-gray-600">D - T</span>
          <span className="font-medium">{formatDelta(row.delta)}</span>
        </div>
      </div>
    </div>
  );
        ...
        <>
          <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-3">
            <div className="bg-white border border-gray-200 rounded-md p-4">
              ...
              <div className="mt-2 text-xs text-gray-500">Latest D - T</div>
              <div className="mt-1 flex items-center gap-2 text-lg font-semibold text-gray-800">
                {latestDelta === null ? "-" : formatDelta(latestDelta)}
                {latestDelta !== null ? (
                  latestDelta >= 0 ? (
          ...
          <div className="mt-6 bg-white border border-gray-200 rounded-md p-4">
            <div className="flex items-center justify-between gap-2 flex-wrap">
              <h2 className="text-base font-semibold text-gray-800">Price trend (Dambulla vs Tambuttegama)</h2>
          ...
          <div className="mt-6 bg-white border border-gray-200 rounded-md p-4">
            <div className="flex items-center justify-between gap-2 flex-wrap">
              <h2 className="text-base font-semibold text-gray-800">Difference (D - T)</h2>
              <div className="text-xs text-gray-500">Green = D higher • Red = T higher</div>
            </div>

            <div className="mt-4" style={{ height: 280 }}>
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={series} margin={{ top: 10, right: 20, bottom: 10, left: 0 }}>
                  <CartesianGrid strokeDasharray="3 3" />
                  <XAxis dataKey="period" tick={{ fontSize: 12 }} interval="preserveStartEnd" />
                  <YAxis tick={{ fontSize: 12 }} />
                  <Tooltip content={<TrendTooltip />} />
                  <Bar dataKey="delta" name="D - T">
